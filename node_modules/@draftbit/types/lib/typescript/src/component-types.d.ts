...
export declare const StylesPanelSections: {
    Background: string;
    Borders: string;
    Effects: string;
    LayoutFlexItems: string;
    LayoutSelectedItem: string;
    LayoutContent: string;
    Margins: string;
    MarginsAndPaddings: string;
    NoStyles: string;
    Position: string;
    Size: string;
    Typography: string;
};
export declare const CONTAINER_COMPONENT_STYLES_SECTIONS: string[];
export declare const BLOCK_STYLES_SECTIONS: string[];
